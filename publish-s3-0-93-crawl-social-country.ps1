...
$stage = Join-Path $root ".publish-s3-0-93-crawl-social-country"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: crawl social follow-up, collectedAt, updates-only, country tabs (s3.0.93)"
...
Write-Host "Published s3.0.93 crawl social/country UX to main"

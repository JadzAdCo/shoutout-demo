...
Write-Host "3. Commit: Rollback from v28.20-f classic board text and attribution fix to previous package"
Write-Host "4. Test with a cache-busting URL, for example:"
Write-Host "   https://jadzadco.github.io/shoutout-demo/?v=28.19-f-rollback-test"

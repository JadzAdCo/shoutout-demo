...
$stage = Join-Path $root ".publish-s3-0-90-master-admin-dc-spot-ads"
$git = "C:\Program Files\Git\cmd\git.exe"
$files = @(
  "master-admin.html",
  "dc-spot-ad-campaigns.js"
)
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "fix: load packaged DC spot ads in Master Admin Ad Campaign Management (s3.0.90)"
...
Write-Host "Published s3.0.90 Master Admin DC spot ads to main"

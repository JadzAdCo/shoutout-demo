...
Write-Host "3. Commit: Rollback from v28.26-f"
Write-Host "4. Test:"
Write-Host "   https://jadzadco.github.io/shoutout-demo/?v=28.25-nf-rollback-test"
Write-Host ""
Write-Host "Optional database/storage cleanup:"
Write-Host "- Remove new inbox notification link fields only if needed."
Write-Host "- Delete profileMedia/{uid}/... files only if storage cleanup is desired."

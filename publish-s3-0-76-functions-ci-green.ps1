...
$stage = Join-Path $root ".publish-s3-0-76-functions-ci-green"
...
$msg = "fix: ship getFloqrClientIp + compliance s3.0.69 so Functions CI matches tests"
...
Write-Host "Published Functions CI green fix to main"

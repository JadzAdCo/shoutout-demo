...
$stage = Join-Path $root ".publish-s3-0-30-service-access"
$git = "C:\Program Files\Git\cmd\git.exe"
$files = @(
  "floqr-service-access.js",
  "floqr-venue-picker.js",
  "patron-portal.html",
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit --trailer "Co-authored-by: Cursor <cursoragent@cursor.com>" -m "s3.0.30: service role request specialty picker and searchable multi-club association"
...
Write-Host "Published s3.0.30 Pages"

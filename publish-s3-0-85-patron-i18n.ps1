...
$stage = Join-Path $root ".publish-s3-0-85-patron-i18n"
...
$files = @(
  ...
  "scripts/merge-patron-portal-chrome.js",
  "scripts/_chrome-merge-patron.json",
  "scripts/patch-patron-search-i18n.js",
  "scripts/fix-patron-search-i18n-quality.js",
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: end-to-end patron Search and Profile i18n (s3.0.85)"
...
Write-Host "Published s3.0.85 patron i18n to main"

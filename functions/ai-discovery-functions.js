...
function defaultFloqrPreviewLinks(v = "29.09.114") {
  ...
  return [
    ...
    ["Scheduling grid + User Guide", `${base}/admin.html?location=temp-democlub-1&v=${v}&tab=scheduling#schedUserGuide`],
...
exports.emailFloqrPreviewLinks = onRequest({
  ...
  try {
    ...
    const packageVersion = String(body.package || body.v || query.package || query.v || "29.09.114").trim();

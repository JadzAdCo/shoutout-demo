...
Write-Host "3. Commit: Rollback from v28.18-f sign-out and Screen 2 cleanup fix to previous package"
Write-Host "4. Test with a cache-busting URL, for example:"
Write-Host "   https://jadzadco.github.io/shoutout-demo/?v=28.17-f-rollback-test"

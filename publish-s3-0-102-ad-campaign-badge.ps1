...
$stage = Join-Path $root ".publish-s3-0-102-ad-campaign-badge"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "fix: Ad Campaign Mgmt Status/Shows-on badge labels (s3.0.102)"
...
Write-Host "Published s3.0.102 Ad Campaign badge labels to main"

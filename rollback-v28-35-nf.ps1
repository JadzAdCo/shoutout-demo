param(
  [string]$RepoRoot = ".",
  [string]$PreviousPackage = "shoutoutwepp,vers-28.34-nf-full-package.zip"
)

Write-Host "FLOQR v28.35-nf rollback helper" -ForegroundColor Cyan
...
Write-Host "v28.35-nf does not add a required migration."
...
Write-Host "No Storage Rules rollback is required for v28.35-nf."

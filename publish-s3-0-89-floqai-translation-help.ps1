...
$stage = Join-Path $root ".publish-s3-0-89-floqai-translation-help"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "docs: FloqAi help for Translation Overrides and language detection (s3.0.89)"
...
Write-Host "Published s3.0.89 FloqAi translation help to main"

...
Write-Host "3. Commit: Rollback from v28.22-f Microsoft authentication troubleshooting fix to previous package"
Write-Host "4. Test with a cache-busting URL, for example:"
Write-Host "   https://jadzadco.github.io/shoutout-demo/?v=28.21-f-rollback-test"

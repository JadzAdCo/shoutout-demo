...
```text
https://jadzadco.github.io/shoutout-demo/guest-list.html?location=shoko-barcelona-spain&v=28
```

Promoter Admin:

```text
https://jadzadco.github.io/shoutout-demo/promoter-admin.html?v=28
```

Club Admin — Zebbies Garden DC:

```text
https://jadzadco.github.io/shoutout-demo/admin.html?location=zebbies-garden-washington-dc&v=28
```
...
```text
https://jadzadco.github.io/shoutout-demo/translation-policy.html?v=28
```
...
```text
guest-list.html?location=zebbies-garden-washington-dc&v=28
```
...
```text
admin.html?location=zebbies-garden-washington-dc&v=28
```
...
```text
https://jadzadco.github.io/shoutout-demo/guest-list.html?location=christie-cannes-france&v=28
```
...
```text
https://jadzadco.github.io/shoutout-demo/patron-portal.html?v=28
```

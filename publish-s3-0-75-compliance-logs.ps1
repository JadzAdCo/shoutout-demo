...
$stage = Join-Path $root ".publish-s3-0-75-compliance-logs"
...
$msg = "s3.0.75: rename Completed log to Compliance Logs and add CSV export"
...
Write-Host "Published s3.0.75 Pages"

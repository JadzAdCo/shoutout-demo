...
$stage = Join-Path $root ".publish-s3-0-81-club-marketing-tabs"
...
$files = @(
  ...
  "scripts/patch-club-marketing-i18n.js",
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: Club Admin Marketing tab group with i18n and help (s3.0.81)"
...
Write-Host "Published s3.0.81 club marketing tabs to main"

...
$stage = Join-Path $root ".publish-s3-0-83-patron-search-i18n"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: localize patron Search hub ShoutOut and Mingl chrome (s3.0.83)"
...
Write-Host "Published s3.0.83 patron search i18n to main"

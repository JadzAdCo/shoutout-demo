...
$stage = Join-Path $root ".publish-s3-0-87-place-i18n"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: localize venue places genres and offerings on listing cards (s3.0.87)"
...
Write-Host "Published s3.0.87 place i18n to main"

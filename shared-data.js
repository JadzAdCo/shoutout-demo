...
window.SHOUTOUT_CLUB_LOCATIONS = {
  ...
  "heist-washington-dc": {
    ...
    VenueSupports96x48:0, VenueSupports64x48:1, VenueSupports64x32:1,
  ...
  "lima-twist-washington-dc": {
    ...
    templates:["edm","latin","vip","bottle","birthday","neon","gold","soccerJersey"],
    soccerJerseyTeamIds:["soccerCameroon","soccerRussia","soccerUkraine"],
    displayScreenFormatIds:["led-96x48","led-64x48","led-64x32"],
    VenueSupports96x48:1, VenueSupports64x48:1, VenueSupports64x32:1,
    primaryDisplayScreenFormatId:"led-96x48",
...
(function seedTempDemoClubs(locations) {
  const showcase = window.FLOQRTempQaShowcase;
  for (let n = 1; n <= 10; n += 1) {
    const id = `temp-democlub-${n}`;
    if (showcase?.clubRecord) {
      locations[id] = Object.assign({}, locations[id] || {}, showcase.clubRecord(n, false));
      continue;
    }

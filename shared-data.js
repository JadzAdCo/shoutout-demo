...
window.SHOUTOUT_CLUB_LOCATIONS = {
  ...
  "heist-washington-dc": {
    ...
    templates:["heistVaultNight","heistPoliceCar","heistInterrogation","heistVaultDollars"],
...
Object.assign(window.SHOUTOUT_TEMPLATES, {
  ...
  heistVaultNight: {
    ...
    identityRail:true,
    identityMessages:['Caught in HEISTS','Powered by FloqR Social OS'],
    ...
    maxSubCharacters:28,
    description:'Heist DC exclusive: Jail Bars background with floating transparent framed text (3×14). Identity rail cycles optional patron handle (3s), then “Caught in HEISTS” (3s), then “Powered by FloqR Social OS” (3s), each bursting away.',
  ...
  heistPoliceCar: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Police Car background with floating transparent framed text (3×14). Identity rail cycles optional patron handle (3s), then “Caught in HEISTS” (3s), then “Powered by FloqR Social OS” (3s), each bursting away.',
  ...
  heistInterrogation: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Interrogation background with floating transparent framed text (3×14). Identity rail cycles optional patron handle (3s), then “Caught in HEISTS” (3s), then “Powered by FloqR Social OS” (3s), each bursting away.',
  ...
  heistVaultDollars: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Vault Night background with floating transparent framed text (3×14). Identity rail cycles optional patron handle (3s), then “Caught in HEISTS” (3s), then “Powered by FloqR Social OS” (3s), each bursting away.',

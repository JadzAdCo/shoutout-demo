...
window.SHOUTOUT_CLUB_LOCATIONS = {
  "zebbies-garden-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ ZEBBIES DC", defaultSub:"",
  ...
  "gaia-supperclub-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ GAIA", defaultSub:"Downtown DC",
  ...
  "onyx-rooftop-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ ONYX", defaultSub:"Dupont After Dark",
  ...
  "vera-cocina-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ VERA", defaultSub:"Ivy City",
  ...
  "sax-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ SAX", defaultSub:"Downtown DC",
  ...
  "rosebar-lounge-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ ROSEBAR", defaultSub:"Connecticut Ave",
  ...
  "kata-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ KATA", defaultSub:"Chinatown",
  ...
  "shoko-barcelona-spain": {
    ...
    defaultMain:"USE ShoutOut @ SHÔKO", defaultSub:"",
  ...
  "chrystie-cannes-france": {
    ...
    defaultMain:"USE ShoutOut @ CHRYSTIE", defaultSub:"",
  ...
  "cococure-london-uk": {
    ...
    defaultMain:"USE ShoutOut @ COCOCURE", defaultSub:"",
  ...
  "hi-ibiza-spain": {
    ...
    defaultMain:"USE ShoutOut @ HÏ IBIZA", defaultSub:"",
  ...
  "pacha-ibiza-spain": {
    ...
    defaultMain:"USE ShoutOut @ PACHA IBIZA", defaultSub:"",
  ...
  "cavo-paradiso-mykonos-greece": {
    ...
    defaultMain:"USE ShoutOut @ CAVO PARADISO", defaultSub:"",
  ...
  "the-club-milan-italy": {
    ...
    defaultMain:"USE ShoutOut @ THE CLUB MILANO", defaultSub:"",
  ...
  "casamara-rooftop-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ CASAMARA", defaultSub:"18th Street rooftop",
  ...
  "miami-demo-fl": {
    ...
    brand:"MIAMI x FLOQR",
    defaultMain:"USE ShoutOut @ MIAMI", defaultSub:"",
  ...
  "atlanta-demo-ga": {
    ...
    defaultMain:"USE ShoutOut @ ATLANTA", defaultSub:"",
  ...
  "nyc-demo-ny": {
    ...
    brand:"NYC x FLOQR",
    defaultMain:"USE ShoutOut @ NYC", defaultSub:"",
  ...
  "la-demo-ca": {
    ...
    brand:"LA x FLOQR",
    defaultMain:"USE ShoutOut @ LA", defaultSub:"",
  ...
  "signature-club-washington-dc": {
    ...
    defaultMain:"USE ShoutOut @ SIGNATURE CLUB", defaultSub:"",
  ...
  "josephine-atlanta-ga": {
    ...
    defaultMain:"USE ShoutOut @ JOSEPHINE", defaultSub:"",
  ...
  "marquee-new-york-ny": {
    ...
    defaultMain:"USE ShoutOut @ MARQUEE", defaultSub:"",
  ...
  "lavo-new-york-ny": {
    ...
    defaultMain:"USE ShoutOut @ LAVO", defaultSub:"",
  ...
  "nebula-new-york-ny": {
    ...
    defaultMain:"USE ShoutOut @ NEBULA", defaultSub:"",
  ...
  "academy-los-angeles-ca": {
    ...
    defaultMain:"USE ShoutOut @ ACADEMY LA", defaultSub:"",
    genres:["EDM","House","Tech House"], artists:["International DJs"],
    activityStatus:"Active nightlife seed location",
  ...
  "exchange-la-ca": {
    ...
    defaultMain:"USE ShoutOut @ EXCHANGE LA", defaultSub:"",
    genres:["EDM","House","Dance"], artists:["International DJs"],
    activityStatus:"Active nightlife seed location",
  ...
  "sound-nightclub-los-angeles-ca": {
    ...
    defaultMain:"USE ShoutOut @ SOUND", defaultSub:"",
  ...
  "liv-miami-fl": {
    ...
    defaultMain:"USE ShoutOut @ LIV", defaultSub:"",
  ...
  "club-space-miami-fl": {
    ...
    defaultMain:"USE ShoutOut @ CLUB SPACE", defaultSub:"",
  ...
  "e11even-miami-fl": {
    ...
    defaultMain:"USE ShoutOut @ E11EVEN", defaultSub:"",
    genres:["Hip Hop","EDM","Open Format"], artists:["Celebrity DJs"],
    activityStatus:"Active nightlife seed location",
  ...
  "district-atlanta-ga": {
    ...
    defaultMain:"USE ShoutOut @ DISTRICT", defaultSub:"",
  ...
  "tongue-groove-atlanta-ga": {
    ...
    defaultMain:"USE ShoutOut @ TONGUE & GROOVE", defaultSub:"",
    genres:["Hip Hop","Open Format","House"], artists:["Resident DJs"],
    activityStatus:"Active nightlife seed location",
    activityDates:["Friday Open Format","Saturday VIP Night"],
  ...
  "reve-atlanta-ga": {
    ...
    defaultMain:"USE ShoutOut @ REVE", defaultSub:"",
  ...
  "shoko-barcelona-beach-club-spain": {
    ...
    defaultMain:"USE ShoutOut @ SHÔKO BEACH", defaultSub:"",
  ...
  "nammos-mykonos-greece": {
    ...
    defaultMain:"USE ShoutOut @ NAMMOS", defaultSub:"",
...
Object.assign(window.SHOUTOUT_TEMPLATES, {
  ...
  birthdayMedia: { id:'birthdayMedia', name:'Happy Birthday with image/video placeholder', scope:'Shared', className:'celebration-media', category:'Milestone', mediaMode:'Image/video placeholder', supportsMedia:true, layout:'split-media', textProfileId:'birthdayMedia', screenFormatIds:['p125-96x48','led-96x48'], defaultMain:'HAPPY BIRTHDAY', defaultSub:'', lineCount:3, maxCharactersPerLine:15, maxMainCharacters:45, maxSubCharacters:20, identityRail:true, identityAnimation:'burst-away', identityAnimationSeconds:20, hideSecondary:true, mediaColumnScale:1.2, primaryTextScale:1.15, description:'Birthday split layout rule notes (96×48 cm displays only — largest panel). Media placeholder is 20% larger than the base split (≈60/40 media/message). Primary message only — secondary verbiage is removed. Primary text renders 15% larger than other split-media templates, with a 45-character main ceiling (3×15). The bottom FloqR card uses the same appear/disappear burst as Traditional Black and White (PRESENTED BY FLOQR ShoutOut when blank; FROM {name} when attributed). Not offered on 64×48 or 64×32 panels.', tags:["birthday","happy birthday","image","video","photo","flowers","placeholder","celebration","45 characters","floqr card","burst animation","no secondary","identity rail","96x48 only","largest display"] },
  ...
  heistVaultNight: {
    ...
    textOverlay:true,
    frameOverlay:true,
    frameOverlayStyle:'css-heist',
    defaultFrameOverlayUrl:'',
  ...
  heistRedLux: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Legacy alias for Tengo muchos dólares (Vault Night).',
    tags:["heist","alias","vault night"]
  },
  soccerJersey: {
    id:'soccerJersey',
    name:'Soccer Jersey',
...
window.FLOQR_TEMPLATE_TEXT_PROFILES = {
  ...
  birthdayMedia: {
    label:"Birthday media with FloqR card (96×48 only)",
    formats:{
      "p125-96x48": {supported:true,lineCount:3,maxCharactersPerLine:15,maxMainCharacters:45,maxSubCharacters:20,minimumFontPixels:54},
      "p125-64x48": {supported:false,lineCount:0,maxCharactersPerLine:0,maxMainCharacters:0,maxSubCharacters:0,minimumFontPixels:0,advice:"Birthday with image/video is limited to the largest 96 × 48 cm display."},
      "p125-64x32": {supported:false,lineCount:0,maxCharactersPerLine:0,maxMainCharacters:0,maxSubCharacters:0,minimumFontPixels:0,advice:"Birthday with image/video is limited to the largest 96 × 48 cm display."},
      "led-96x48": {supported:true,lineCount:3,maxCharactersPerLine:15,maxMainCharacters:45,maxSubCharacters:20,minimumFontPixels:44},
      "led-64x48": {supported:false,lineCount:0,maxCharactersPerLine:0,maxMainCharacters:0,maxSubCharacters:0,minimumFontPixels:0,advice:"Birthday with image/video is limited to the largest 96 × 48 cm display."},
      "led-64x32": {supported:false,lineCount:0,maxCharactersPerLine:0,maxMainCharacters:0,maxSubCharacters:0,minimumFontPixels:0,advice:"Birthday with image/video is limited to the largest 96 × 48 cm display."}
    }
  },
  car: {

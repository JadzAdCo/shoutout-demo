...
Object.assign(window.SHOUTOUT_TEMPLATES, {
  ...
  heistVaultNight: {
    ...
    maxSubCharacters:28,
    description:'Heist DC exclusive: Jail Bars background with floating transparent framed text (3×14). Classic identity rail cycles “$Caught in HEISTS” then “Powered by FloqR Social OS” and bursts away.',
  ...
  heistPoliceCar: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Police Car background with floating transparent framed text (3×14). Classic identity rail cycles “$Caught in HEISTS” then “Powered by FloqR Social OS” and bursts away.',
  ...
  heistInterrogation: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Interrogation background with floating transparent framed text (3×14). Classic identity rail cycles “$Caught in HEISTS” then “Powered by FloqR Social OS” and bursts away.',
  ...
  heistVaultDollars: {
    ...
    maxMainCharacters:42,
    maxSubCharacters:28,
    description:'Heist DC exclusive: Vault Night background with floating transparent framed text (3×14). Classic identity rail cycles “$Caught in HEISTS” then “Powered by FloqR Social OS” and bursts away.',

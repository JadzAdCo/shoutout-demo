...
window.SHOUTOUT_CLUB_LOCATIONS = {
  ...
  "heist-washington-dc": {
    ...
    templates:["heistVaultNight","heistPoliceCar","heistInterrogation","heistVaultDollars","soccerMorocco","soccerSpain","soccerChelsea","soccerParisSaintGermain","soccerMonaco"],
...
Object.assign(window.SHOUTOUT_TEMPLATES, {
  ...
  soccerMorocco: {
    ...
    name:'Soccer Morocco',
    scope:'Shared',
    className:'soccer-jersey soccer-morocco',
    category:'Sports',
    mediaMode:'No image/video',
    supportsMedia:false,
    backgroundEditable:false,
    ...
    description:'Shared $30 Soccer Morocco jersey-back ShoutOut. Display name (pick or type) across the upper back; jersey mark accepts any 2 characters centered below (FIFA-proportion spacing).',
    tags:["soccer","football","morocco","jersey","world cup","name","number","$30","shared"]
  },
  soccerSpain: {
    id:'soccerSpain',
    name:'Soccer Spain',
    scope:'Shared',
    className:'soccer-jersey soccer-spain',
    category:'Sports',
    mediaMode:'No image/video',
    supportsMedia:false,
    backgroundEditable:false,
    ...
    jerseyNumberField:true,
    jerseyNumberMaxChars:2,
    description:'Shared $30 Soccer Spain jersey-back ShoutOut. Display name (pick or type) across the upper back; jersey mark accepts any 2 characters centered below (FIFA-proportion spacing).',
    tags:["soccer","football","spain","jersey","world cup","name","number","$30","shared"]
  },
  soccerChelsea: {
    id:'soccerChelsea',
    name:'Soccer Chelsea',
    scope:'Shared',
    className:'soccer-jersey soccer-chelsea',
    category:'Sports',
    mediaMode:'No image/video',
    supportsMedia:false,
    backgroundEditable:false,
    ...
    jerseyNumberField:true,
    jerseyNumberMaxChars:2,
    description:'Shared $30 Soccer Chelsea jersey-back ShoutOut. Display name (pick or type) across the upper back; jersey mark accepts any 2 characters centered below.',
    tags:["soccer","football","chelsea","jersey","premier league","name","number","$30","shared"]
  },
  soccerParisSaintGermain: {
    id:'soccerParisSaintGermain',
    name:'Soccer Paris Saint-Germain',
    scope:'Shared',
    className:'soccer-jersey soccer-psg',
    category:'Sports',
    mediaMode:'No image/video',
    supportsMedia:false,
    backgroundEditable:false,
    ...
    jerseyNumberField:true,
    jerseyNumberMaxChars:2,
    description:'Shared $30 Soccer Paris Saint-Germain jersey-back ShoutOut. Display name (pick or type) across the upper back; jersey mark accepts any 2 characters centered below.',
    tags:["soccer","football","psg","paris saint-germain","jersey","name","number","$30","shared"]
  },
  soccerMonaco: {
    id:'soccerMonaco',
    name:'Soccer Monaco',
    scope:'Shared',
    className:'soccer-jersey soccer-monaco',
    category:'Sports',
    mediaMode:'No image/video',
    supportsMedia:false,
    backgroundEditable:false,
    ...
    jerseyNumberField:true,
    jerseyNumberMaxChars:2,
    description:'Shared $30 Soccer Monaco jersey-back ShoutOut. Display name (pick or type) across the upper back; jersey mark accepts any 2 characters centered below.',
    tags:["soccer","football","monaco","jersey","ligue 1","name","number","$30","shared"]
  }
});

window.SHOUTOUT_STANDARD_TEMPLATE_IDS = ['blackwhite','birthdayMedia','anniversaryMedia','engagementMedia','fianceMedia','car','summer','champagne','beach','graduation','wedding','sports','luxury','corporate','soccerMorocco','soccerSpain','soccerChelsea','soccerParisSaintGermain','soccerMonaco'];

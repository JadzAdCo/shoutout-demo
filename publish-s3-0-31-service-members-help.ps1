...
$stage = Join-Path $root ".publish-s3-0-31-service-members-help"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit --trailer "Co-authored-by: Cursor <cursoragent@cursor.com>" -m "s3.0.31: patron-facing Services & Service Members help and full i18n"
...
Write-Host "Published s3.0.31 Pages"

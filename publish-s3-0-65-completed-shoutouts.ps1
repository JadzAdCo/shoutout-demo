...
$stage = Join-Path $root ".publish-s3-0-65-completed-shoutouts"
...
$msg = "s3.0.65: keep approved shoutouts for Completed history; recover paid orders after legacy deletes"
...
Write-Host "Published s3.0.65 Completed ShoutOuts fix"

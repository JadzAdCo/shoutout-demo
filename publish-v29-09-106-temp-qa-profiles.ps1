...
$stage = Join-Path $root ".publish-v29-09-106"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "QA temp-democlub profiles: icons, venue art, employee cards, full datapoints (v29.09.106)"
...
Write-Host "Published v29.09.106 Pages"

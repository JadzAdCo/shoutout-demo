...
$stage = Join-Path $root ".publish-s3-0-63-ci-fix"
$git = "C:\Program Files\Git\cmd\git.exe"
$files = @("functions/commerce-invariants.test.js")
...
$msg = "fix(ci): allow emoji-OK shoutout placeholder in commerce invariants"
...
Write-Host "Published CI fix to main"

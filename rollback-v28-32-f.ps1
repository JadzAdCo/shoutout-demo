param(
  [string]$RepoRoot = ".",
  [string]$PreviousPackage = "shoutoutwepp,vers-28.31-f-full-package.zip"
)

Write-Host "FLOQR v28.32-f rollback helper" -ForegroundColor Cyan
...
Write-Host "v28.32-f does not add a new database migration."
...
Write-Host ""
Write-Host "No new Firestore Rules or Storage Rules rollback is required for v28.32-f."

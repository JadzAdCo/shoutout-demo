...
(function () {
  ...
  const PREVIEW_LINKS_PACKAGE = "29.09.106";
  ...
  const PACKAGE_INSTALL_CHECKS = [
    ...
    },
    {
      ...
      checks: [
        ...
        {label:"Main Mingl page extra chat card/frame removed", file:"index.html", includes:["minglRequestsList", "minglPeopleGrid"], notIncludes:["id=\"minglChatPanel\"", "id=\"minglChatList\"", "<h2>Mingl Chat</h2>", "Open Mingl Chat"]},
    ...
    },
    {
      ...
      checks:[
        ...
        {label:"Current rule version markers", file:"firestore.rules", includes:["FLOQR FIRESTORE RULES VERSION: v29.08-stripe-connect-hardening", "clubAdminAssignments", "stripeConnectAccounts", "emailOtpChallenges"]},

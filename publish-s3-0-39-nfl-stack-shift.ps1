...
$stage = Join-Path $root ".publish-s3-0-39-nfl-stack-shift"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "s3.0.39: NFL uniform stack shift, ScammerVille neckline and helmet"
...
Write-Host "Published s3.0.39 Pages"

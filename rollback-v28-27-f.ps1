...
Write-Host "3. Commit: Rollback from v28.27-f"
Write-Host "4. Test:"
Write-Host "   https://jadzadco.github.io/shoutout-demo/?v=28.26-f-rollback-test"
Write-Host ""
Write-Host "Storage rules rollback:"
Write-Host "- Use Firebase Console > Storage > Rules history to restore previous rules if needed."

...
$stage = Join-Path $root ".publish-s3-0-82-greek-marketing-label"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "fix: Greek Club Admin Marketing tab label (s3.0.82)"
...
Write-Host "Published s3.0.82 Greek marketing label to main"

...
$stage = Join-Path $root ".publish-s3-0-69-session-ip"
...
$msg = "s3.0.69: capture public IP during ShoutOut session (getFloqrClientIp)"
...
Write-Host "Published s3.0.69 session IP capture"

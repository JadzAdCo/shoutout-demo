...
$stage = Join-Path $root ".publish-s3-0-72-nfl-floqr-width"
...
$files = @(
  ...
  "display.html",
  "display2.html",
  "functions/nfl-jersey-dual.test.js",
...
$msg = "s3.0.72: NFL +15% width again, club nameplate up, patron name between plate and number, FloqR card rebuild"
...
Write-Host "Published s3.0.72 Pages"

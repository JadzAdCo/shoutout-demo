/* FLOQR Commerce storefront and seller tools v29.08. */
(function () {
  "use strict";
  ...
  async function resolveEntity(user) {
    ...
    if (entityType === "club") {
      ...
      canManage = (entity.adminUids || []).includes(user.uid)
        || (assignment?.exists && String(assignment.data()?.status || "").toLowerCase() === "active");
    } else {

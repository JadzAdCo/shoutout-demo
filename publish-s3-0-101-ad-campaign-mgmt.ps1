...
$stage = Join-Path $root ".publish-s3-0-101-ad-campaign-mgmt"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "fix: Ad Campaign Mgmt Preview + human targeting forms (s3.0.101)"
...
Write-Host "Published s3.0.101 Ad Campaign Mgmt to main"

...
$stage = Join-Path $root ".publish-s3-0-36-nfl-scale-fix"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "s3.0.36: restore NFL jersey silhouette scale, ScammerVille helmet fix"
...
Write-Host "Published s3.0.36 Pages"

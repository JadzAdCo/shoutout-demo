...
$stage = Join-Path $root ".publish-s3-0-34-nfl-scammerville-from"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "s3.0.34: ScammerVille NFL collar/helmet, jersey FROM card attribution"
...
Write-Host "Published s3.0.34 Pages"

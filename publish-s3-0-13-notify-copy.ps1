...
$stage = Join-Path $root ".publish-s3-0-13"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "Publish FLOQR s3.0.13: General Notifications copy for patron flags and paid Twilio"
...
Write-Host "Published s3.0.13 Pages"

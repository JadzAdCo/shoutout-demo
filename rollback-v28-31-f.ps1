param(
  [string]$RepoRoot = ".",
  [string]$PreviousPackage = "shoutoutwepp,vers-28.30-f-full-package.zip"
)

Write-Host "FLOQR v28.31-f rollback helper" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "No new Firestore Rules or Storage Rules rollback is required for v28.31-f."

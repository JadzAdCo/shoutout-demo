...
(function () {
  ...
  async function recordMinglRequest({connectionId, targetUid, targetProfile, nextStatus, sharedLabels}) {
    ...
    const base = {
      ...
      status:nextStatus,
      link:"./patron-portal.html?tab=inbox&v=28.94-mingl-chat-consent-actions",
      minglLink:"./mingl-chat.html?v=28.94-mingl-chat-consent-actions",
      read:false,
      createdAt:now
    };
    const writes = [
  ...
  function portalChatUrl(roomId = "") {
    const params = new URLSearchParams({v:"28.94-mingl-chat-consent-actions"});
  ...
  async function submitShoutout() {
    ...
    try {
      ...
      payload.modifyLink = `./patron-portal.html?tab=shoutouts&ref=${encodeURIComponent(payload.referenceNumber)}&id=${encodeURIComponent(shoutoutRef.id)}&v=28.94-mingl-chat-consent-actions`;
  ...
  function ensureProfileMenuEnhancements(user) {
    ...
    if (!menu.querySelector("[data-patron-menu='portal']")) {
      ...
      portalLink.href = "./patron-portal.html?v=28.94-mingl-chat-consent-actions";
      ...
      messages.href = "./patron-portal.html?tab=inbox&v=28.94-mingl-chat-consent-actions";
      ...
      chats.href = "./mingl-chat.html?v=28.94-mingl-chat-consent-actions";
...
(function(){
  ...
  async function enhanceMenu(user){
    ...
    menu.innerHTML = `
      ...
      <a class="profile-menu-link" href="./patron-portal.html?v=28.94-mingl-chat-consent-actions">My Profile and Settings</a>
      <div class="profile-menu-line">Member Level: Patron</div>
      <a class="profile-menu-link" href="./patron-portal.html?tab=inbox&v=28.94-mingl-chat-consent-actions">FLOQR Inbox (${c.um}/${c.tm})</a>
      <a class="profile-menu-link" href="./mingl-chat.html?v=28.94-mingl-chat-consent-actions">Mingl (${c.uc}/${c.tc})</a>
...
window.createShoutOutSubmissionNotification=async function(s){const link=s.modifyLink||`./patron-portal.html?tab=shoutouts&ref=${encodeURIComponent(s.referenceNumber||"")}&v=28.94-mingl-chat-consent-actions`;await note({type:"shoutoutSubmitted",title:"ShoutOut Submitted",body:`Your ShoutOut was submitted for ${s.locationName||s.clubName||s.clubLocationId||"the selected venue"}.\n\nModify ShoutOut: ${link}`,referenceNumber:s.referenceNumber||"",shoutoutId:s.shoutoutId||"",clubLocationId:s.clubLocationId||s.location||currentLoc(),status:s.status||"pending",link});};

...
$stage = Join-Path $root ".publish-s3-0-35-classic-bw-idle"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "s3.0.35: classic B&W idle dark board, 64x48 48-char cap, emoji on other templates"
...
Write-Host "Published s3.0.35 Pages"

...
$stage = Join-Path $root ".publish-s3-0-98-master-shoutout-ui"
$git = "C:\Program Files\Git\cmd\git.exe"
$files = @(
  "master-admin.html",
  "master-admin-shoutouts.js",
  "floqr-i18n.js",
  "floqai-help-repository.js",
  "README.md",
  "functions/shoutout-compliance.test.js",
  "scripts/patch-master-shoutout-i18n.js"
)
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "fix: Master Admin Completed Log / Retention labels; remove Ops Status (s3.0.98)"
...
Write-Host "Published s3.0.98 Master Admin shoutout UI to main"

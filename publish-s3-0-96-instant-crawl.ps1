...
$stage = Join-Path $root ".publish-s3-0-96-instant-crawl"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    & $git commit -m "feat: Instant Crawl Now with contact-lift report (s3.0.96)"
...
Write-Host "Published s3.0.96 Instant Crawl to main"
